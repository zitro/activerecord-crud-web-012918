...
def can_be_found_updated_and_saved
  ...
  Movie.create(title: "Awesome Flick")
	themovie = Movie.find_by(title: "Awesome Flick")#found
	themovie.update(title: "Even Awesomer Flick")#updated
	themovie.save #saved
...
def can_update_using_update_method
  ...
  themovie = Movie.create(title: "Wat?")
	themovie.update(title: "Wat, huh?")#updated
